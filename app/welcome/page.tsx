...
export default function Welcome () { 
    return (
        <div className="welcome-section bg-amber-200 text-black ">
            <div className="welcome-left-section  scrollbar-hide-default">
            ...
            <div className="welcome-right-section bg-[#FF9280]">
